                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text-success"><i class="fa fa-map-marker"></i> Region
                                                                City</td>
                                                            <td>{{ $registration->region_city }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-success"><i class="fa fa-map"></i> Zone Subcity
                                                            </td>
                                                            <td>{{ $registration->zone_subcity }}</td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div id="General" class="tab-pane fade">
                                            @if ($registration->file)
                                                <div class="card card-body scrollable-box"
                                                    ...
                                                    <iframe src="{{ asset('storage/' . $registration->file) }}"
                                        ...
                                        <form action="{{ route('expert.approval.post', $registration->id) }}"
                                            method="POST">
                                            @csrf
