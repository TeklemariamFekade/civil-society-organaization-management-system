                ...
                <div class="bg-white rounded shadow">
                    <div class="px-6 pt-6 border-bottom border-secondary-light m-3">
                        <div class="d-flex mb-6 align-items-center justify-content-between">
                            <h4 class="mb-0">List of Registration Requests</h4>
                            ...
                            <tbody>
                                ...
                                @foreach ($csos as $cso)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($cso->registration)
                                                @foreach ($cso->registration as $registration)
                                                    {{ $registration->send_date }}
                                                @endforeach
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-success" data-toggle="modal"
                                                data-target="#mdl-{{ $registration->id }}">Assign</button>
                                            <div class="modal fade" id="mdl-{{ $registration->id }}" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title text-center font-weight-bolder">Task
                                                                assign page</h5>
