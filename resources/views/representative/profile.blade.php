    ...
    <div class="content-wrapper">
        <div class="container mx-auto">
            <div class="mx-4">
                ...
                <form action="{{ route('representative.updateProfile', $representative->id) }}" method="POST"
                        ...
                        <div class="col-md-12 border-right">
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="name" value="{{ $representative->name }}"
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        @if ($representative->photo)
                                            <img src="{{ asset($representative->photo) }}" alt="Profile Photo"
                                                width="100">
                                        @else
                    ...
                    <div class="form-group m-2 text-center d-flex justify-content-center">
                        <a href="{{ Route('representative.dashboard') }}" class="btn btn-dark mx-2">
