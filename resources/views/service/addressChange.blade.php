                ...
                <div class="container border-1 mt-5">
                    <div class="col-sm-11 ml-1">
                        ...
                        <div class="bg-white  m-3  pb-5  text-justify">
                            ...
                            <p class="p-3 ">
                                Civil Society Organizations should notify changes of their Head office, and other adress
                                information. The Authority for Civil Society Organizations provides
                                confirmation message for the notification.</p>
                            ...
                            <div class="mt-auto border text-end float-right mr-3">
                                <a href="{{ Route('service.addressChangeForm') }}" class="btn btn-dark">Agree and
